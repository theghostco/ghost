!function e(){let i=document.location.origin+"/gallery-content?format=json-pretty",t=document.querySelector(".switcher-gallery-wrapper");if(t){let s=document.createElement("div");s.className="switcher-outer-container",s.innerHTML=`
...
</div>`,t.append(s);let l=document.createElement("div");l.className="gallery-container";let a=document.createElement("div");a.className="gallery-items",l.append(a),t.append(l);let r=document.createElement("div");r.className="list-container",r.classList.add("hidden-block"),t.append(r);let c=document.createElement("div");c.className="list-items",c.innerHTML=`
