...
!function(){ 
    ...
    l.classList.add("background-container-inner"), 
    ...
    document.addEventListener("DOMContentLoaded",()=>{ 
        if (e && document.body.classList.add("page-with-bg"), i) { 
            ...
            let pageBg = document.querySelector(".page-with-bg"); 
            let color1 = pageBg ? getComputedStyle(pageBg).getPropertyValue("--color1").trim() || "#ffffff" : "#ffffff"; 
            let color2 = pageBg ? getComputedStyle(pageBg).getPropertyValue("--color2").trim() || "rgb(250, 255, 184)" : "rgb(250, 255, 184)"; 
            ...
            !function e({timing:t,draw:a,duration:i}){ 
                ...
                draw(e){ 
                    ...
                    (t=e)<=d||(t>=1?(a.forEach(e=>e.classList.remove("active")), 
                    a[a.length-1].classList.add("active")):(a.forEach(e=>e.classList.remove("active")), 
                    l++, 
                    d+=1/a.length, 
