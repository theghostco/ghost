window.Squarespace.onInitialize(Y, function() { 
  ...
  if (typeof(isGallery) != 'undefined' && isGallery != null){
    ...
    var ifSection = document.querySelectorAll('section .summary-item-list-container.sqs-gallery-container')[0];
    var ifFooter = document.querySelectorAll('.Footer-inner .summary-item-list-container.sqs-gallery-container')[0];
    ...
    document.querySelectorAll('.summary-item-list-container.sqs-gallery-container').forEach(function(thisListGalleryContainer){
      ...
      // if (typeof(ifSection) != 'undefined' && ifSection != null){
      //   thisListGalleryContainer.closest('section').classList.add('section-with-testimonials-v1');
      // }else if(ifFooter){
    ...
    setTimeout(function(){
      console.log('ali');
      mySwiper[0].updateSlidesClasses(); 
   },3000);
